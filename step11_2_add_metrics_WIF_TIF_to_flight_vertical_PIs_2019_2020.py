...
for year in YEARS:
    ...
    for month in MONTHS:
        ...
        for week in WEEKS:
            ...
            filename = "PIs_vertical_by_flight_" + year + '_' +  month + '_week' + str(week) + ".csv"
...
# merge vertical PIs by flight with normalised metrics and WIF on date and hour
...
# merge vertical PIs by flight with normalised metrics and TIF on date and hour
