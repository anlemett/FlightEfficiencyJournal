...
def calculate_hfe_by_hour(year, month, week, runway):
    ...
    for date, date_df in hfe_by_flight_df.groupby(level='endDate'):
        ...
        for hour in range(0,24):
            ...
            if number_of_flights_hour == 0:
                ...
                additional_distance_hour = runway_hour_df['additionalDistanceTMA'].values # np array
                ...
                distance_change_percent_hour = runway_hour_df['distanceChangePercent'].values # np array
...
def create_hfe_by_hour_file(hfe_by_hour_df, runway):
    ...
    output_filename = AIRPORT_ICAO + "_PIs_horizontal_by_hour_runway" + runway + ".csv"
    ...
    for year in YEARS:
        ...
        for month in MONTHS:
            ...
            for week in WEEKS:
                ...
                hfe_by_hour_df_week = calculate_hfe_by_hour(year, month, week, runway)
                
                hfe_by_hour_df = hfe_by_hour_df.append(hfe_by_hour_df_week, ignore_index=True)
    
    create_hfe_by_hour_file(hfe_by_hour_df, runway)
